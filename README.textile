...
Release: 0.5.4-preview (2009-09-07)
...
* Linux, *BSD, Solaris
** Pcap 0.6 (optional, for packet sniffing)
* Ruby 1.8.x or 1.9.x
* Ruby Libraries
** fastthread
** mongrel
...
* Download from RubyForge: http://stella.rubyforge.org/
* gem install stella 
...
Monitor HTTP traffic using Pcap packet filter
